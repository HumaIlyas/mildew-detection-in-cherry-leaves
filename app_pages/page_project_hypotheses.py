...
def page_project_hypotheses_content():
    ...
    st.info(
        ...
        "* An average image and varability image study can help to investigate "
        "it. \n"
        "* There were clear white powdery spots on the surface of the mildew "
        "contained leaves. \n"
        "* An Image Montage shows that typically a mildew contained leaves have "
        "clear white powdery spots on the surface. \n"
        "2. I suggest that images of mildew-contained cherry leaves will have "
        "several differences compared with uninfected leaves in order to train "
        "the model with an image dataset. \n"
