...
def page_project_hypotheses_content():
    ...
    st.info(
        ...
        "* There were clear white powdery spots on the surface of the mildew contained leaves. \n"
        "* An Image Montage shows that typically a mildew contained leaves have clear white powdery spots on the surface. \n"
